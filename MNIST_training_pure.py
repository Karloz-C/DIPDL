...
def run(f):
    ...
    node=p2p.Node()
    filename1 = "./log/4/pure/loss/" + "loss_" + str(node.PORT) + ".txt"
    filename2 = "./log/4/pure/error/" + "Test_error_" + str(node.PORT) + ".txt"
    filename3 = "./log/4/pure/time/" + "time_correspond" + str(node.PORT) + ".txt"
    filename4 = "./log/4/pure/time/" + "time_compute" + str(node.PORT) + ".txt"
