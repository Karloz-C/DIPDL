...
class DiscoveryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.tell_public_key = channel.unary_unary(
                '/Discovery/tell_public_key',
...
def add_DiscoveryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'tell_public_key': grpc.unary_unary_rpc_method_handler(
                    servicer.tell_public_key,
...
class Discovery(object):
    ...
    def tell_public_key(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Discovery/tell_public_key',
...
class Consensus(object):
    ...
    def tell_public_key(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Consensus/tell_public_key',
            grpc__pb2.Message.SerializeToString,
            grpc__pb2.Message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
